...
\begin{document}
    ...
    \section{Koordinatendarstellungen}
        ...
        \begin{itemize}
            \item grad \(\phi(r;\varphi) = \cfrac{\partial \phi}{\partial r}\vec{e}_r + \cfrac{1}{r} \cdot \cfrac{\partial \phi}{\partial \varphi}\vec{e}_{\varphi}\) 
            \item div \(\vec{F}(r;\varphi) = \cfrac{1}{r} \cdot \cfrac{\partial}{\partial r}(r \cdot F_r) + \cfrac{1}{r} \cdot \cfrac{\partial F_{\varphi}}{\partial \varphi}  \)
