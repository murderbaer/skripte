...
\begin{document}
    ...
    \section{Lineare Differentialgleichungen 2. Ordnung}
        ...
        Für die Lösung wird wieder das Prinzip aus der DGL 2. Ordnugn genommen. Bei der homogonen Lösung wird nun eine Linearkombination aus \(C_n \cdot \lambda^n \) und 
        zwar aus allen \(n\) gebildet. Sind die Nullstellen gefunden, werden diese dann in den Ansatz eingefügt.
        Hat man eine \(r\)-Fache Nullstelle wird ein Polynom \(r-1\)sten grades mit \(e^{x \cdot \lambda_{m/n/o/...}}\) multipliziert .\\        
        Man hat eine DGL 5. Grades und eine 4-Fache Nullstelle ergibt sich folgender Ansatz: 
        \begin{equation}
