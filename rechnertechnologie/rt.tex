...
\begin{document}
    ...
    \section{Bus Systems}
        ...
        \subsection{UART, RS232}
            ...
            \end{itemize}
            8N1 was a common impelemtation. 8 data bits, one stop bit and no parity bit (+ 1 start bit)%I think
        ...
        \subsection{I\(^2\)C}     
            ...
            I\(^2\)C defines three basic messaging types, while each begin with START and end with a STOP:
            \begin{enumerate}
