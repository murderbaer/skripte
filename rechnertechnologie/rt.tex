...
\begin{document}
    ...
    %
        \subsection{addresses}
            ...
            \begin{itemize}
                ...
                %TODO pre/post modifying indirect addressing TODO 134 has some inforamtion which may be usefull
            \end{itemize}
    ...
    \section{Bus Systems}
        ...
        \subsection{I\(^2\)C}     
            ...
            I\(^2\)C defines three basic messagin types, while each begin with START and end with a STOP:
            \begin{enumerate}
